...
- O jogador deve acionar um comando de pulo para vencer a gravidade momentaneamente e ganhar altitude, clicando espaço no teclado, botão direito do mouse ou na seta do teclado.

- Cada par de obstáculos ultrapassado com sucesso concede 1 ponto ao jogador.

- O personagem possui 3 vidas. Cada colisão com um obstáculo, com o chão ou com o teto consome uma vida e reinicia a pontuação.
...
- **Clique esquerdo do mouse**: Realizar a ação de "pular".

- **Seta para cima do teclado**: Realizar a ação de "pular".
